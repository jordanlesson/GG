...
class NumberPicker extends StatelessWidget {
  ...
  Widget _integerListView(ThemeData themeData) {
    TextStyle defaultStyle = themeData.textTheme.body1.copyWith(color: Color.fromRGBO(0, 150, 255, 1.0), fontFamily: "Avenir", fontWeight: FontWeight.w500);
    TextStyle selectedStyle =
    themeData.textTheme.headline.copyWith(color: Color.fromRGBO(0, 150, 255, 1.0), fontFamily: "Avenir", fontWeight: FontWeight.bold);
